function googleTranslateElementInit() {
  ...
  $("#spanish").click(function () {
    ...
    $.get(url, function (data, status) {
        ...
        $(".topNavFavourite").text(data.data.translations[1].translatedText);
        ...
        $(".sideNavFavourite").text(data.data.translations[5].translatedText);
